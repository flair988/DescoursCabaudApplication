...
describe('Service Tests', () => {
  describe('Group Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Group(123, 0, 'AAAAAAA', 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Group', async () => {
      ...
      it('should not partial update a Group', async () => {
      ...
      it('should return a list of Group', async () => {
        const returnedFromService = Object.assign(
          {
            groupId: 1,
            groupNumber: 'BBBBBB',
      ...
      it('should not return a list of Group', async () => {
        axiosStub.get.rejects(error);
