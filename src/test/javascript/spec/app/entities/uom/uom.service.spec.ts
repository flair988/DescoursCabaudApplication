...
describe('Service Tests', () => {
  describe('Uom Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Uom(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Uom', async () => {
      ...
      it('should not update a Uom', async () => {
      ...
      it('should not partial update a Uom', async () => {
      ...
      it('should return a list of Uom', async () => {
        const returnedFromService = Object.assign(
          {
            itemId: 'BBBBBB',
            uom: 'BBBBBB',
      ...
      it('should not return a list of Uom', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Uom', async () => {
